...
numeric_data2 <- numeric_data[,numeric_columns_to_keep]
...
for(x in chi_sq_df$feature[1:25]){
  plot_categorical_variable(x)
}
```

```{r}
numeric_data3 <- VIM::kNN(numeric_data2)
